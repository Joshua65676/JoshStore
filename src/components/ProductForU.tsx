        ...
        <div className="grid xl:grid-cols-4 md:grid-cols-3 gap-5 items-center justify-center">
          {products.length > 0 ? (
            products.map((product) => (
              ...
              >
                <div className="flex flex-col gap-3 xl:w-[17rem] mx:w-[17rem] xm:w-[16rem]  ml-4 mt-5 mx:ml-4">
            ...
            <div className="flex items-center justify-center text-center">
              <div
                className="inline-block h-8 w-8 animate-spin rounded-full border-4 border-solid border-current border-e-transparent align-[-0.125em] text-surface motion-reduce:animate-[spin_1.5s_linear_infinite] dark:text-Black items-center text-center"
                role="status"
              >
                <span className="!absolute !-m-px !h-px !w-px !overflow-hidden !whitespace-nowrap !border-0 !p-0 ![clip:rect(0,0,0,0)] text-Black text-center">
                  Loading...
                </span>
              </div>
            </div>
